...
if(isset($_POST['submit'])){
    ...
    if(count($errors)>0){
        ...
        echo '<div class="alert alert-success" role="alert">Благодарим Ви за съобщението, '.$_POST['name'].'! На имейл адрес '. $_POST['e-mail'].' ще получите отговор.</div>';
    }
}
?>
...
<form method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="email" class="form-control" id="email" placeholder="Your Email" name="e-mail">
    </div>
    <div class="mb-3">

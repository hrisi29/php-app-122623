...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2024 at 10:16 PM
...
--
-- Dumping data for table `favorite_products_users`
--
...
(11, '<script>alert(\'GET HACKED!!\');</script>', 'https://cdncloudcart.com/25880/products/images/28368/apple-macbook-air-m1-8gb-ddr4x-256gb-ssd-13-3-wqxga-gold-image_61a8cf36e50dc_600x600.jpeg?1638782461', '123.00');
...
(9, 'Simeon3', 'simeon3@abv.bg', '$argon2i$v=19$m=65536,t=4,p=1$bDd4OXhQYllwR085L204OA$2jJL+jR/qQAqinPW3qOtXTsOdalEteR/vY76u3IrRrc'),
(11, 'Симеон4', 'simeon4@abv.bg', '$argon2i$v=19$m=65536,t=4,p=1$NW0wMHhpYzJCdXpaQ2NINg$cwmI1sMbj1VYaM7A4gzp874gf7pYnijnmD+retn2M+M'),
(12, '<script>alert(\'GET HACKED!!\');</script>', 'simeon5@abv.bg', '$argon2i$v=19$m=65536,t=4,p=1$dklVdWNva2ZKajdpOXFPcA$5kEoorj8sOneOJyRS3eJTTYMtAg2Pn+MDganf89gYLo');
...
--
ALTER TABLE `products`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Първичен ключ', AUTO_INCREMENT=12;
